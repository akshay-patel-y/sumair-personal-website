  ...
  export const experiences: Experience[] = [
    {
      ...
      bullets: [
        ...
        "Constructed service/asset filtering API using gRPC & GoLang; Led to advanced discoverability based on sub-attributes",
    ...
    },
    {
      ...
      title: "Machine Learning Infrastructure Engineering Intern (Y Combinator W2018)",
      bullets: [
    ...
    },
    {
      ...
      description: "Trashbots is a technology startup that develops low-cost science and engineering kits with a structured curriculum that enables students to develop problem-solving skills and enhance their creativity by building robots that utilize materials from the world around them.",
